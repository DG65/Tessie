...
class TessieVehicle extends IPSModule
{
    ...
    public function Create()
    {
        ...
        // Optional cleanup: remove obsolete auto-created links (and old root if LinksLocation changed)
    ...
    private function cleanupOldRootIfNeeded(int $currentLinksParent): void
    {
        ...
        if ($oldRootId > 0) {
            // Only delete if it still has our ident and is a category
    ...
    private function cleanupLinksUnder(int $parentId, array $keepIdents): void
    {
        ...
        foreach ($children as $cid) {
            ...
            // Only touch links we manage (prefix LNK_)
